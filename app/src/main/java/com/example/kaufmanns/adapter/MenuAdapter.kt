...
import com.example.kaufmanns.databinding.MenuItemBinding

class MenuAdapter(
    private val menuItemsName: List<String>,
    private val menuItemPrice:MutableList<String>, private val MenuImage:MutableList<Int>,private val requirContext:Context): RecyclerView.Adapter<MenuAdapter.MenuViewHolder>() {
